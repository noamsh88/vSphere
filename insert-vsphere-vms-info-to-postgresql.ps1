...
$vCenterName = 'nt-vcqa2.nova.co.il'
$password = Get-Content D:\Devops\SecureCred\password.txt | ConvertTo-SecureString -Key (Get-Content D:\Devops\SecureCred\aes.key)
$Credentials = New-Object System.Management.Automation.PsCredential("nova\tfsbuild",$password)
